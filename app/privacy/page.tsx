...
const sections = [
  ...
  },
  {
    ...
    body:
      "Googleログインで取得する情報は、本人確認とアカウント表示のために使います。Google Calendar連携を有効にした場合は、候補日時を作るときに予定の重なりを確認するため、予定の開始・終了時刻、予定名、場所を取得します。予定の説明、参加者、Meet URL、添付ファイルなどは取得しません。Google Calendarの予定詳細はデータベースに保存せず、画面表示のためだけに使います。連携用トークンは暗号化して保存し、連携解除時に削除します。"
  },
  {
    title: "4. 共有リンク",
    body:
