...
const sections = [
  {
    title: "1. 取得する情報",
    body:
      "Madoi は、ログインに必要なユーザーID、メールアドレス、表示名、イベント情報、候補日時、回答内容、コメント、共有リンク、リマインド送信済み記録、通知、支払い履歴、清算金額、支払い方法メモ、支払い先URLに関する情報を扱います。"
  },
  {
    title: "2. 利用目的",
    body:
      "取得した情報は、ログイン、予定の作成、候補日時の管理、共有リンクによる回答、回答状況の表示、清算状況の整理、支払い確認、サイト内通知、サービスの保守、不正利用の防止に使います。"
  },
  {
  ...
  },
  {
    title: "4. 共有リンク",
    body:
      "共有リンクを知っている人は、ログインせずに日程回答や清算状況の確認ができる場合があります。共有リンクを受け取った人には、イベント名、候補日時、回答フォーム、清算の支払い状況、支払い先メモなどが表示されることがあります。"
  },
  {
    title: "5. 第三者提供",
    body:
  ...
  },
  {
    title: "6. 外部サービス",
    body:
      "Madoi は、認証やデータ保存のために Supabase、Googleログイン、Google Calendar などの外部サービスを使います。支払い先URLとして外部決済サービスや銀行振込情報へのリンクを利用者が入力する場合がありますが、Madoi は外部決済APIによる送金や入金確認は行いません。各サービスでは、それぞれの規約やプライバシーポリシーが適用されます。"
  },
  {
    title: "7. 保管期間と削除",
    body:
