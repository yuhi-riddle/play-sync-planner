...
const sections = [
  ...
  {
    title: "4. 共有リンク",
    body: "イベントへの招待リンクは、ログイン済みの利用者を参加者として登録するために使います。招待リンクを不用意に公開しないでください。"
  },
  {
    title: "5. 第三者提供",
    body: "法令に基づく場合を除き、利用者の情報を本人の同意なく第三者へ提供しません。イベントに入力された内容は、そのイベントの参加者に表示されます。"
  },
  {
    title: "6. 外部サービス",
    body: "Madoi は、認証、データ保存、Google ログインと Google Calendar 連携のために外部サービスを利用します。各サービスに送られる情報は、それぞれのプライバシーポリシーに従って扱われます。"
  },
  {
    title: "7. 安全管理",
