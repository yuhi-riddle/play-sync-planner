...
const sections = [
  ...
  },
  {
    ...
    body:
      "Google ログインで取得する情報は、本人確認とアカウント表示のために使います。Google Calendar連携を有効にした場合は、候補日時を作るときに予定の重なりを確認するため、空き時間確認に必要な予定時間帯だけを取得します。Phase 2-Aでは、予定名、場所、説明、参加者などの予定詳細は取得しません。連携用トークンは暗号化して保存し、連携解除時に削除します。"
  },
  {
    title: "4. 共有リンク",
    body:
      "共有リンクを知っている人は、ログインせずに日程回答できる場合があります。共有リンクを受け取った人には、予定名、候補日時、回答フォームが表示されます。"
  },
  {
    title: "5. 第三者提供",
    body:
  ...
  },
  {
    title: "6. 外部サービス",
    body:
      "Madoi は、認証やデータ保存のために Supabase、Google ログイン、Google Calendar などの外部サービスを使います。各サービスでは、それぞれの規約やプライバシーポリシーが適用されます。"
  },
  {
    title: "7. 保管期間と削除",
    body:
  ...
  },
  {
    title: "9. 問い合わせ",
    body:
      "問い合わせ先は正式公開前に設定します。運用開始時には、連絡先メールアドレスまたは問い合わせフォームをこのページに掲載します。"
  }
];
