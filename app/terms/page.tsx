...
const sections = [
  ...
  },
  {
    title: "3. 入力する情報",
    body:
      "利用者は、予定名、カテゴリ、場所メモ、候補日時、回答内容などを入力できます。共有リンクを知っている人は、ログインせずに回答できる場合があります。共有リンクの扱いには注意してください。"
  },
  {
    title: "4. 禁止事項",
    body:
  ...
  },
  {
    title: "6. 免責",
    body:
      "Madoi は、日程調整を補助するためのサービスです。入力内容の正確性、予定の成立、外部サービスの状態について、運営者は保証しません。"
  },
  {
    title: "7. 規約の変更",
    body:
