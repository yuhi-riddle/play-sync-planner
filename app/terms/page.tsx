...
const sections = [
  ...
  },
  {
    title: "3. 入力する情報",
    body:
      "利用者は、予定名、カテゴリ、場所メモ、候補日時、回答内容、支払い履歴、清算メモ、支払い先URLなどを入力できます。共有リンクを知っている人は、ログインせずに回答や清算状況の確認ができる場合があります。共有リンクの扱いには注意してください。"
  },
  {
    title: "4. 禁止事項",
    body:
  ...
  },
  {
    title: "5. サービスの変更・停止",
    body:
      "Madoi は開発中のサービスです。機能の追加、変更、停止が発生することがあります。重要な予定は、必要に応じて別の方法でも控えてください。"
  },
  {
    title: "6. 免責",
    body:
      "Madoi は、日程調整と清算状況の整理を補助するためのサービスです。入力内容の正確性、予定の成立、支払いの完了、外部サービスの状態について、運営者は保証しません。実際の送金や支払いは、利用者同士の責任で行ってください。"
  },
  {
    title: "7. 規約の変更",
    body:
