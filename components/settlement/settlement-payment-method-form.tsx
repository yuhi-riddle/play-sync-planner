...
import { PaymentMethodField } from "@/components/settlement/payment-method-field";
  ...
  return (
    <Card>
      ...
      <form action={action} className="mt-4 grid gap-3">
        <PaymentMethodField defaultValue={currentValue} label={label} name="settlement_payment_method" />
        <button
          type="submit"
