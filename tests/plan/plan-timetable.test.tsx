...
import { ParticipantToggleChips } from "@/components/plan/participant-toggle-chips";
...
import type { TimetableItem } from "@/lib/domain/plan/plan-timetable";
...
describe("ParticipantToggleChips", () => {
  ...
  it("すでに担当になっている参加取消者は「取消」と出し、「辞退」とは出さない", () => {
    // components/plan/plan-timetable.tsx の一覧バッジは declined/cancelled で文言を分けている
