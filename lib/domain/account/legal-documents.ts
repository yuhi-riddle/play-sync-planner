...
export const LEGAL_EFFECTIVE_DATE = "2026年9月26日";
...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  {
    title: "8. 退会と削除",
    body: "設定画面から退会できます。退会すると、つながり(フォロー・グループ・ブロック)、通知、イベントの下書き、Google Calendar の連携用トークン、ニックネームとプロフィール画像を削除します。一方で、イベントと清算の記録は残ります。同じイベントに参加した他の利用者の記録を壊さないためです。退会後、あなたの表示名は「退会したユーザー」に変わりますが、清算の相手が分からなくなるのを避けるため、日程調整の参加者名はそのまま残ります。退会したアカウントではログインできません。"
  },
  {
    title: "9. 運営者とお問い合わせ",
