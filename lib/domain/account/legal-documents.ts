...
export const LEGAL_EFFECTIVE_DATE = "2026年8月11日";

/**
 * 運営者と問い合わせ先。規約とポリシーの両方から参照する。
 * 片方だけ直して食い違うのを避けたいので、文字列は1箇所に置く。
 */
export const LEGAL_OPERATOR_NAME = "ゆうひ（個人）";
export const LEGAL_CONTACT_EMAIL = "adeliaekun@gmail.com";

export const TERMS_SECTIONS: LegalSection[] = [
  {
    title: "1. 適用",
    body: "この利用規約は、Madoi を利用するすべての方に適用されます。Madoi の利用には Google アカウントでのログインが必要で、ログインせずに使える機能はありません。日程回答や清算の共有リンクも、招待された参加者本人がログインして開きます。ログイン時に同意していただいた時点で、この規約に同意したものとします。"
  },
  {
    title: "2. アカウント",
  ...
  {
    title: "8. 運営者とお問い合わせ",
    body: `Madoi は ${LEGAL_OPERATOR_NAME} が運営しています。規約に関するお問い合わせは ${LEGAL_CONTACT_EMAIL} で受け付けます。個人で運営しているため、返信までに時間がかかることがあります。`
  }
];
...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  {
    title: "4. 共有範囲",
    body: "ニックネームと設定したプロフィール画像は、同じイベントの参加者や招待候補になった利用者に表示されることがあります。イベントに入力された内容は、そのイベントの参加者に表示されます。日程回答や清算の共有リンクは、リンクを知っているだけでは開けません。招待された参加者がログインして開いた場合にだけ、イベント名、候補日時、回答や清算に必要な情報が表示されます。"
  },
  {
    title: "5. 外部サービス",
  ...
  {
    title: "9. 運営者とお問い合わせ",
    body: `Madoi は ${LEGAL_OPERATOR_NAME} が運営しています。プライバシーに関するお問い合わせや、保存している情報の開示・訂正・削除のご依頼は ${LEGAL_CONTACT_EMAIL} で受け付けます。個人で運営しているため、返信までに時間がかかることがあります。`
  }
];
